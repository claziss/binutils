...
#define SIMM9_8_PCREL       (UIMM6_20_PCREL + 1)
    ...
    /* UIMM3_13_S_PCREL mask = 0000000000000111 */
#define UIMM3_13_S_PCREL       (SIMM9_8_PCREL + 1)
    {3, 0, -UIMM3_13_S_PCREL, ARC_OPERAND_UNSIGNED, insert_uimm3_13_s, extract_uimm3_13_s},

    /* UIMM7_A32_11_S_PCREL mask = 0000000000011111 */
#define UIMM7_A32_11_S_PCREL       (UIMM3_13_S_PCREL + 1)
    {7, 0, -UIMM7_A32_11_S_PCREL, ARC_OPERAND_UNSIGNED | ARC_OPERAND_ALIGNED32 | ARC_OPERAND_TRUNCATE | ARC_OPERAND_IGNORE, insert_uimm7_a32_11_s, extract_uimm7_a32_11_s},

    /* UIMM8_8_S_PCREL mask = 0000000011111111 */
#define UIMM8_8_S_PCREL       (UIMM7_A32_11_S_PCREL + 1)
    {8, 0, -UIMM8_8_S_PCREL, ARC_OPERAND_UNSIGNED, insert_uimm8_8_s, extract_uimm8_8_s},

    /* SIMM12_20_PCREL mask = 00000000000000000000111111222222 */
...
const struct arc_flag_special arc_flag_special_cases[] =
  {
    ...
    { "jl", { F_ALWAYS, F_RA, F_EQUAL, F_ZERO, F_NOTEQUAL, F_NOTZERO, F_POZITIVE, F_PL, F_NEGATIVE, F_MINUS, F_CARRY, F_CARRYSET, F_LOWER, F_CARRYCLR, F_NOTCARRY, F_HIGHER, F_OVERFLOWSET, F_OVERFLOW, F_NOTOVERFLOW, F_OVERFLOWCLR, F_GT, F_GE, F_LT, F_LE, F_HI, F_LS, F_PNZ, F_NULL } },
    ...
    { "ld", { F_DI11, F_A9, F_AW9, F_AB9, F_AS9, F_SIGN6, F_SIZEB7, F_SIZEW7, F_H7, F_DI15, F_A22, F_AW22, F_AB22, F_AS22, F_SIGN16, F_SIZEB17, F_SIZEW17, F_H17, F_NULL } },
...
const struct arc_opcode arc_relax_opcodes[] =
  {
    ...
    { "add_s", 0x00006800, 0x0000F818, ARC_OPCODE_ARC600 | ARC_OPCODE_ARC700 | ARC_OPCODE_ARCv2EM | ARC_OPCODE_ARCv2HS, { RC_S, RB_S, UIMM3_13_S_PCREL }, { 0 }},
    ...
    { "ld_s", 0x00008000, 0x0000F800, ARC_OPCODE_ARC600 | ARC_OPCODE_ARC700 | ARC_OPCODE_ARCv2EM | ARC_OPCODE_ARCv2HS, { RC_S, BRAKET, RB_S, UIMM7_A32_11_S_PCREL, BRAKETdup }, { 0 }},
    { "ld", 0x10000000, 0xF8000000, ARC_OPCODE_ARC600 | ARC_OPCODE_ARC700 | ARC_OPCODE_ARCv2EM | ARC_OPCODE_ARCv2HS, { RA, BRAKET, RB, SIMM9_8_PCREL, BRAKETdup }, { C_DI20, C_AA21, C_X25, C_ZZ23 }},
    ...
    { "mov_s", 0x0000D800, 0x0000F800, ARC_OPCODE_ARC600 | ARC_OPCODE_ARC700 | ARC_OPCODE_ARCv2EM | ARC_OPCODE_ARCv2HS, { RB_S, UIMM8_8_S_PCREL }, { 0 }},
    { "mov", 0x208A0000, 0xF8FF0000, ARC_OPCODE_ARC600 | ARC_OPCODE_ARC700 | ARC_OPCODE_ARCv2EM | ARC_OPCODE_ARCv2HS, { RB, SIMM12_20_PCREL }, { C_F }},
    { "mov", 0x200A0F80, 0xF8FF0FC0, ARC_OPCODE_ARC600 | ARC_OPCODE_ARC700 | ARC_OPCODE_ARCv2EM | ARC_OPCODE_ARCv2HS, { RB, LIMM }, { C_F }},
  };
